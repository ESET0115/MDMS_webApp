    ...
    <div className="login-page">
      ...
      <main className="login-main">
        <div className="login-card glass-card">
          ...
          <p className="login-subtitle">Access your MDMS dashboard</p>

          <form className="login-form" onSubmit={handleSubmit}>
            <input
              className="pill-input glass-input"
              type="email"
            ...
            <div className="form-row space-between remember-row">
              <label className="remember">
                <input type="checkbox" />
                <span>remember me</span>
              </label>
            ...
            <button type="submit" className="login-btn neo-btn" disabled={loading}>
              {loading ? "Logging in..." : "Login"}
            </button>
          </form>
        </div>
